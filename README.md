...
- Para el formulario, sus validaciones se encuentran en el archivo formulario.js, además para la confirmación se abre una nueva ventana que indica si quieres enviar el formulario o no, en caso de apretar si, en esa misma ventana sale una alerta indicando el mensaje de que se envió el formulario, luego se cierra la página y la página del formulario lleva a la página principal.
